...
{
	$result = mysql_query("INSERT INTO cart( email, field_1, field_2, field_3, field_4,
							field_5, field_12,created_date	)
					VALUES(	'$get_email','$get_field_1', '$get_field_2', '$get_field_3', 
							'$get_field_4', '$get_field_5','$get_field_12', '$get_created_date')");
